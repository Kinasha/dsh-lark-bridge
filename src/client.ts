...
const en = {
  ...
  restart: "Changes apply automatically; active turns keep their current presentation.",
  ...
  progressSurface: "Thinking chain surface",
  ...
  toolDetailMode: "Tool detail level",
  progressStyle: "Progress layout",
  thinkingIcon: "Reasoning icon",
  maxProgressItems: "Progress entry limit",
  collapseProgressOnFinish: "Collapse progress when finished",
...
const zh: typeof en = {
  ...
  restart: "修改会自动生效；正在执行的 Turn 保持创建时的展示设置。",
  loading: "正在读取设置…",
  loadFailed: "设置读取失败。",
  save: "保存",
  saving: "正在保存…",
  ...
  progressSurface: "思维链形态",
  alwaysPostFinal: "同时发送纯文本回复",
  streamPrintFrequencyMs: "打字机间隔（毫秒）",
  streamPrintStep: "每次显示字符数",
  streamElementMaxChars: "单个卡片组件字符上限",
  toolDetailMode: "工具详情等级",
  progressStyle: "执行过程布局",
  thinkingIcon: "思维步骤图标",
  maxProgressItems: "执行过程条目上限",
  collapseProgressOnFinish: "完成后折叠执行过程",
...
export const FIELDS: Array<{
  ...
  { name: "progressSurface", label: "progressSurface" },
  ...
  { name: "toolDetailMode", label: "toolDetailMode" },
  { name: "progressStyle", label: "progressStyle" },
  { name: "thinkingIcon", label: "thinkingIcon" },
  { name: "maxProgressItems", label: "maxProgressItems" },
  { name: "collapseProgressOnFinish", label: "collapseProgressOnFinish" },
